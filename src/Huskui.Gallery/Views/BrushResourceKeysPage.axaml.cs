...
public partial class BrushResourceKeysPage : ControlPage
{
    ...
    [
        ...
        new("Overlay Surfaces",
            ...
            [
                CreateEntry("OverlayBackgroundBrush",
                ...
                CreateEntry("OverlayReversedBackgroundBrush",
                ...
                CreateEntry("OverlayInteractiveBackgroundBrush",
                ...
                CreateEntry("OverlaySolidBackgroundBrush",
                ...
                CreateEntry("OverlaySmokeBackgroundBrush",
                            "Backdrop dimmer",
                ...
                CreateEntry("OverlayMaskBackgroundBrush",
                            "Heavy modal scrim",
        ...
        new("Neutral Control Brushes",
            ...
            CreateControlFamilyEntries("Control", "neutral", "Gray", "7", "5", "7", "7", "9", "12", "11")),
        CreateVariantSection("Accent Control Brushes",
                             "Semantic control brushes for primary emphasis and brand-colored interaction.",
                             "Accent keeps the exact same naming grid as the neutral Control family. Swap to this family when the control needs to communicate primary emphasis without changing how the control is structured.",
                             "ControlAccent",
                             "accent",
                             "Accent"),
        CreateVariantSection("Success Control Brushes",
                             "Semantic control brushes for positive outcomes, confirmations, and healthy states.",
                             "Success is the semantic green family. Use it when the control itself needs to communicate confirmation, completion, or healthy state rather than merely decorating surrounding content.",
                             "ControlSuccess",
                             "success",
                             "Success"),
        CreateVariantSection("Warning Control Brushes",
                             "Semantic control brushes for cautionary but non-destructive interaction states.",
                             "Warning is for caution, attention, and reversible risk. It is the right fit when the user should slow down, but not necessarily stop.",
                             "ControlWarning",
                             "warning",
                             "Warning"),
        CreateVariantSection("Danger Control Brushes",
                             "Semantic control brushes for destructive, irreversible, or critical interaction states.",
                             "Danger is the strongest semantic family. Reserve it for destructive actions or critical error states where visual urgency is part of the interaction contract.",
                             "ControlDanger",
                             "danger",
                             "Danger"),
        new("Foreground Helpers",
            ...
            [
                ...
                CreateEntry("ControlReversedForegroundBrush",
                            ...
                            "Source: Gray1Color"),
                CreateEntry("ControlWhiteForegroundBrush",
                ...
                CreateEntry("ControlBlackForegroundBrush",
    ...
    private static BrushSection CreateVariantSection(
        ...
        new(title,
            description,
            namingNote,
            CreateControlFamilyEntries(familyPrefix, familyLabel, sourcePrefix, "8", "9", "8", "9", "9", "9", "11"));

    private static IReadOnlyList<BrushEntry>
    ...
    [
        ...
        CreateEntry($"{familyPrefix}TranslucentHalfBackgroundBrush",
        ...
        CreateEntry($"{familyPrefix}TranslucentFullBackgroundBrush",
        ...
        CreateEntry($"{familyPrefix}ForegroundBrush",
        ...
        CreateEntry($"{familyPrefix}TranslucentForegroundBrush",
    ...
    private static BrushEntry CreateEntry(string key, string role, string usage, string source, string? note = null) =>
        new(key, role, usage, source, note, ResolveBrush(key));

    private static IBrush ResolveBrush(string key)
    {
        if (Application.Current?.TryFindResource(key, Application.Current.ActualThemeVariant, out var resource) == true
...
public sealed record BrushSection(string Title, string Description, string NamingNote, IReadOnlyList<BrushEntry> Items)
{
