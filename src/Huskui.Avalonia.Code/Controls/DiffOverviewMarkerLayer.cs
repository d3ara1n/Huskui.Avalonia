...
public class DiffOverviewMarkerLayer : Control
{
    ...
    static DiffOverviewMarkerLayer() => AffectsRender<DiffOverviewMarkerLayer>(MarkersProperty);
    ...
    private void EnsureBrushes()
    {
        ...
        _addedBrush = TryBrush("ControlSuccessBackgroundBrush", new SolidColorBrush(Color.FromRgb(0x2B, 0x9A, 0x66)));
        _removedBrush = TryBrush("ControlDangerBackgroundBrush", new SolidColorBrush(Color.FromRgb(0xDC, 0x3E, 0x42)));
        _modifiedBrush = TryBrush("ControlAccentBackgroundBrush", new SolidColorBrush(Color.FromRgb(0x00, 0x90, 0xFF)));
    }
    ...
    public override void Render(DrawingContext context)
    {
        ...
        foreach (var marker in Markers)
        {
            ...
            context.DrawRectangle(BrushFor(marker.Kind), null, new(x, y, MARKER_WIDTH, markerHeight));
        }
    }
}
