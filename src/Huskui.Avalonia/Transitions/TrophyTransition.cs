...
public sealed class TrophyTransition() : PageTransitionBase(TimeSpan.FromMilliseconds(300))
{
    protected override void Configure(Builder from, Builder to, Lazy<Visual> parentAccessor)
    {
        ...
        from.Animation(new BackEaseIn())
            ...
            .AddFrame(
                1d,
                [(ScaleTransform.ScaleXProperty, 0.5d), (ScaleTransform.ScaleYProperty, 0.5d)]
            );
        ...
        to.Animation(new CubicEaseOut())
            .AddFrame(
                ...
                [
                    ...
                    (ScaleTransform.ScaleXProperty, 0d),
                    (ScaleTransform.ScaleYProperty, 0d),
                ]
            )
            .AddFrame(
                0.5d,
                [(ScaleTransform.ScaleXProperty, -0.6d), (ScaleTransform.ScaleYProperty, 0.6d)]
            )
            .AddFrame(
                1d,
                [
