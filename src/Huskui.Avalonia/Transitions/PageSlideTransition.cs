...
public class PageSlideTransition(TimeSpan? duration = null) : PageTransitionBase(duration)
{
    ...
    public PageSlideTransition()
        : this(TimeSpan.FromMilliseconds(297)) { }
    ...
    protected override void Configure(Builder from, Builder to, Lazy<Visual> parentAccessor)
    {
        ...
        to.Animation(new SplineEasing(0.4, 0.0, 0.2))
        ...
        to.Animation(new CubicEaseOut())
            ...
            .AddFrame(
                0d,
                [(ScaleTransform.ScaleXProperty, 1.02d), (ScaleTransform.ScaleYProperty, 1.02d)]
            )
            .AddFrame(
                1d,
                [(ScaleTransform.ScaleXProperty, 1.0d), (ScaleTransform.ScaleYProperty, 1.0d)]
            );
    }
}
