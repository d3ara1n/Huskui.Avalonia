...
{
    public static readonly StyledProperty<object?> PastContentProperty =
        AvaloniaProperty.Register<TimelineControl, object?>(nameof(PastContent));

    public static readonly StyledProperty<object?> NowContentProperty =
        AvaloniaProperty.Register<TimelineControl, object?>(nameof(NowContent));
