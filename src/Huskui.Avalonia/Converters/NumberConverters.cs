...
public static class NumberConverters
{
    ...
    public static IValueConverter IsNonZero { get; } =
        new RelayConverter((v, _) => !IsObjectZero(v));

    public static IValueConverter IsPositive { get; } =
        new RelayConverter(
            (v, _) =>
                v switch
                {
    ...
    public static IValueConverter IsNegative { get; } =
        new RelayConverter(
            (v, _) =>
                v switch
                {
