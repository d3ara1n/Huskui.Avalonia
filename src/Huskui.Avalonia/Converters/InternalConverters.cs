...
internal static class InternalConverters
{
    ...
    public static IValueConverter KeyGestureToString { get; } =
        new RelayConverter(
            (v, _) =>
            {
                return v switch
    ...
    public static IValueConverter ToDisplayIndex { get; } =
        new RelayConverter(
            (v, _) =>
            {
                if (v is int index)
    ...
    public static IValueConverter CountToArray { get; } =
        new RelayConverter(
            (v, _) =>
            {
                if (v is int count)
    ...
    /// </summary>
    public static IValueConverter RatingStarFillToOpacity { get; } =
        new RelayConverter(
            (v, _) =>
            {
    ...
    /// </summary>
    public static IMultiValueConverter RatingStarClipGeometry { get; } =
        new RelayMultiConverter(
            (v, _, _) =>
            {
