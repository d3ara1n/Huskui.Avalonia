...
{
    public static IValueConverter WithoutBottom { get; } =
        new RelayConverter(
            (v, _) =>
                v switch
                {
    ...
    public static IValueConverter WithoutTop { get; } =
        new RelayConverter(
            (v, _) =>
                v switch
                {
    ...
    public static IValueConverter WithoutLeft { get; } =
        new RelayConverter(
            (v, _) =>
                v switch
                {
    ...
    public static IValueConverter WithoutRight { get; } =
        new RelayConverter(
            (v, _) =>
                v switch
                {
    ...
    public static IValueConverter Horizontal { get; } =
        new RelayConverter(
            (v, _) =>
                v switch
                {
    ...
    public static IValueConverter DividedBy { get; } =
        new RelayConverter(
            (v, p) =>
            {
                if (v is double o)
